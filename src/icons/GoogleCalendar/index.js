...
const GoogleCalendarIcon = props => (
  <Svg viewBox='0 0 48 48' width={96} height={96} {...props}>
    <path
      fill='#c7c7c7'
      fillRule='evenodd'
      d='M38 5H10a2 2 0 00-2 2v3h32V7a2 2 0 00-2-2zM14 8a1 1 0 110-2 1 1 0 010 2zm20 0a1 1 0 110-2 1 1 0 010 2z'
      clipRule='evenodd'
    />
    <path
      fill='#1976d2'
    ...
    <path
      fill='#fafafa'
      fillRule='evenodd'
      d='M20.534 26c.984.325 1.687.85 2.105 1.557.433.732.65 1.55.65 2.457 0 1.582-.519 2.826-1.556 3.733-1.037.906-2.363 1.36-3.977 1.36-1.582 0-2.892-.427-3.93-1.282-1.038-.855-1.536-2.014-1.497-3.476l.036-.072h2.242c0 .914.28 1.642.841 2.182.56.541 1.33.811 2.308.811.994 0 1.773-.27 2.337-.811.564-.541.847-1.34.847-2.397 0-1.073-.25-1.864-.751-2.373-.501-.509-1.292-.763-2.373-.763h-2.051V26h4.769zm11.103 0h2.349v8.856h-2.349z'
      clipRule='evenodd'
    />
    <path
      fill='#e0e0e0'
    ...
    <path
      fill='#1976d2'
      fillRule='evenodd'
      d='M6 9c-1.438 0-2.103 1.418-2 2 .823 4.664 3 15 3 15m34 0s2.177-10.336 3-15c0-1.625-1.409-2-2-2'
      clipRule='evenodd'
    />
  </Svg>
)
